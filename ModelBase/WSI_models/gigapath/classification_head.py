...
class ClassificationHead(nn.Module):
    """
    The classification head for the slide_feature encoder

    Arguments:
    ----------
    input_dim: int
        The input dimension of the slide_feature encoder
    latent_dim: int
        The latent dimension of the slide_feature encoder
    feat_layer: str
        The layers from which embeddings are fed to the classifier, e.g., 5-11 for taking out the 5th and 11th layers
    n_classes: int
        The number of classes
    model_arch: str
        The architecture of the slide_feature encoder
    pretrained: str
        The path to the pretrained slide_feature encoder
    freeze: bool
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # setup the slide_feature encoder
    ...
    def forward(self, images: torch.Tensor, coords: torch.Tensor) -> torch.Tensor:
        ...
        # forward GigaPath slide_feature encoder
