...
def get_finetune_params():
    ...
    # task settings
    parser.add_argument('--task_cfg_path',  type=str, default='WSI_finetune/task_configs/mutation_5_gene.yaml', help='Path to the task configuration file')
    ...
    parser.add_argument('--val_r',          type=float, default=0.1, help='Ratio of sample used for validation')
