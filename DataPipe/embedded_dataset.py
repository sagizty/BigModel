...
class SlideDatasetForTasks(Dataset):
    def __init__(self,
        ...
        ----------
        data_df: pd.DataFrame
            The dataframe that contains the slide sample
        root_path: str
        ...
        split_key: str
            The key that specifies the column for splitting the sample
        '''
    ...
    def setup_data(self, df: pd.DataFrame, splits: list, task: str='multi_class'):
        '''Prepare the sample for multi-class setting or multi-label setting'''
    ...
    def prepare_multi_class_or_binary_data(self, df: pd.DataFrame, splits: list):
        '''Prepare the sample for multi-class classification'''
...
def embedding_one_slide():
    pass


def embedding_all_slides():
    pass
