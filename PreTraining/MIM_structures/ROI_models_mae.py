"""
MAE Model    Script  ver： Oct 25th 00:30
...
class MaskedAutoencoderViT(VPT_ViT):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
        ...
        #         patch_size=16, slide_embed_dim=768, depth=12, num_heads=12,
        #         decoder_embed_dim=512, decoder_depth=8, decoder_num_heads=16,
    ...
    def initialize_weights(self):
        ...
        pos_embed = get_2d_sincos_pos_embed(self.pos_embed.shape[-1],
                                            ...
                                            cls_token=True)
        # return: pos_embed: [grid_size*grid_size, slide_embed_dim] or [1+grid_size*grid_size, slide_embed_dim] (w/ or w/o cls_token)
    ...
    def patchify(self, imgs):
        """
        Encode image to slide_feature tokens
        ...
        # use reshape to split slide_feature [B, C, H, W] -> [B, C, h_p, p, w_p, p]
    ...
    def unpatchify(self, x, patch_size=None):
        ...
        # use reshape to compose slide_feature [B, C, h_p, p, w_p, p] -> [B, C, H, W]
