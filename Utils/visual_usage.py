"""
Attention Visulization    Script  ver： Oct 23rd 18:00
...
def Draw_tri_fig(Ori_img, Puz_img, Rec_img, picpath):
    plt.figure()
...
def check_SAA(inputs, labels, model, model_idx, edge_size, class_names, model_type='CLS', num_images=-1,
              pic_name='test',
    ...
    for j in range(num_images):
        ...
        for type in checking_type:
            ...
            if type == 'ori':
                ...
                # get a cv2 encoding image from dataloader by inputs[j].cpu().numpy().transpose((1, 2, 0))
