"""
Transfer PuzzleTuning Pre-Training checkpoints    Script  ver： Aug 17th 12:00
...
try:
    ...
    from ROI_pretrianing.SSL_structures import SAE
except:
    from PuzzleAI.ModelBase.ROI_models import Get_ROI_model, GetPromptModel
    from PuzzleAI.ROI_pretrianing.SSL_structures import SAE
...
def transfer_model_encoder(check_point_path, save_model_path, model_idx='ViT', prompt_mode=None,
    ...
    # elif prompt_mode == "Other" or prompt_mode == None:
        ...
        model = Get_ROI_model.get_model(model_idx=model_idx, pretrained_backbone=False, edge_size=edge_size)
    '''
